...
import LogoViewHandler from './components/logoview.js';
...
let routes = (
  <Route name="app" path="/" handler={App}>
    <Router name="top" path="/top" handler={LogoViewHandler}/>
    ...
    <Route name="table" path="/tables" handler={TableViewHandler}/>
  </Route>
)
